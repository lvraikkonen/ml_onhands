# -*- coding: utf-8 -*-
"""
Some evaluation methods to evaulate algorithm
Created on 12th, Jan, 2018
"""
...
def get_metrics(true_labels, predicted_labels):
    """
    popular metrics for evaluating ml algorithm
    """
...
def train_predict_model(classifier,
    ...
    """
    Train model and use model to Predict
    """
    # train
...
def display_confusion_matrix(true_labels, predicted_labels, classes=[1, 0]):
    ...
    cm_frame = pd.DataFrame(data=cm,
                            ...
                            index=pd.MultiIndex(levels=[['Acutal:'], classes], labels=level_labels) )
    print(cm_frame)
